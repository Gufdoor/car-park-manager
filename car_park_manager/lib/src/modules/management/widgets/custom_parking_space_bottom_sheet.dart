          ...
          Row(
            ...
            children: [
              ...
              Switch(
                ...
                // activeTrackColor: LightColorsConstants.uTOrange,
                onChanged: (isUnavailable) {
                  Modular.get<ManagementBloc>().toggleParkingSpaceAvailability(
                    parkingSpace.id,
                  );
                },
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Modular.get<ManagementBloc>().checkOutVehicle(parkingSpace.id);
            },
            child: const Text(
              "Check-out",
              style: TextStyle(
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () {
            Modular.get<ManagementBloc>().checkInVehicle(
